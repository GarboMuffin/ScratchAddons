import {getNormalizedGamepads, normalizeGamepad} from './normalize-broken-gamepads.js';
...
class GamepadLib extends EventTarget {
  ...
  handleConnect(e) {
    ...
    this.connectCallbacks = [];
    const gamepad = normalizeGamepad(e.gamepad);
  ...
  update(time) {
    ...
    const gamepads = getNormalizedGamepads();
