...
export declare abstract class Field<T = any> implements IASTNodeLocationSvg, IASTNodeLocationWithBlock, IKeyboardAccessible, IRegistrable, ISerializable {
     ...
     * @internal
     */
    loadState(state: AnyDuringMigration): void;
    /**
     ...
     */
    loadLegacyState(callingClass: FieldProto, state: AnyDuringMigration): boolean;
    /**
     ...
     * @sealed
     */
    setValue(newValue: AnyDuringMigration, fireChangeEvent?: boolean): void;
    /**
     ...
     */
    protected doValueInvalid_(_invalidValue: AnyDuringMigration, _fireChangeEvent?: boolean): void;
    /**
