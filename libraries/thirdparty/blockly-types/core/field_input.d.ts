...
export declare abstract class FieldInput<T extends InputTypes> extends Field<string | T> {
     ...
     */
    protected doValueInvalid_(_invalidValue: AnyDuringMigration, fireChangeEvent?: boolean): void;
    /**
     ...
     */
    protected setEditorValue_(newValue: AnyDuringMigration, fireChangeEvent?: boolean): void;
