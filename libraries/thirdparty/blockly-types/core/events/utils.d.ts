 ...
 */
export declare function fromJson(json: AnyDuringMigration, workspace: Workspace): Abstract;
/**
 ...
 */
export declare function get(eventType: string): new (...p1: AnyDuringMigration[]) => Abstract;
/**
